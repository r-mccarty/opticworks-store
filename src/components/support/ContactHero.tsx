    ...
    <section className="relative bg-black py-20 sm:py-28">
      ...
      <FadeContainer className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <FadeDiv>
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-gray-800 bg-gray-900/50 mb-6">
              <RiMailLine className="h-7 w-7 text-gray-300" />
            </div>
          </FadeDiv>

          <FadeDiv>
            <h1 className="font-barlow text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Get in touch
            </h1>
          </FadeDiv>

          <FadeDiv>
            <p className="font-colfax mx-auto mt-5 max-w-xl text-lg leading-7 text-gray-400">
